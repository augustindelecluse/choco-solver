...
declare -a valueSelection=("MIN,Best,1,false" "MIN,None,1,false" "GREEDY,None,1,false" "MIN,ReverseBest,1,false")  # each value selection to try
...
do
  ...
  do
    ...
    find data/qap -type f | sed "s/$/-${val}/"  >> $inputFile
  done
done
