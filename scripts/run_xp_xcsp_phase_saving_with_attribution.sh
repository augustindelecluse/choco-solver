...
outFileOpt="results/xcsp/xcsp-opt-phase-saving-${commitId}-${currentDate}.csv"  # filename of the results (with the date at the end of the file)

#valSel,Best,freqBest,PhaseSaving
declare -a valueSelection=("MIN,None,1,true"
"MIN,Best,1,true"
"MIN,BestSubset,1,true"
"MIN,ReverseBest,1,true"
"MIN,ReverseBestSubset,1,true")  # each value selection to try
